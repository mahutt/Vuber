...
function AiChatBot() {
    ...
    const [messages, setMessages] = useState<MessageType[]>([
        {message: "Need a hand with anything? I am your dedicated AI package handleing expert, Vini :) Ask away!",
        sender:"ai",
            direction: "incoming",
         position: "left"
        }       
                        ...
                        <MessageList typingIndicator={ typing ? <TypingIndicator content="Vini is typing"/> : ""}>
                            {messages.map((message,i) =>{
                                return <Message key ={i} model ={{
                                    ...
                                    direction: message.direction === "outgoing" ? "outgoing" : "incoming", // Adjust direction based on the library's requirement
                                    position: message.direction === "outgoing" ? "last" : "first" // Adjust if necessary
                                }}/>
                            })}
                        </MessageList>
