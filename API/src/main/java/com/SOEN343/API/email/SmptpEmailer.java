...
public class SmptpEmailer {

    private static SmptpEmailer instance;

    private SmptpEmailer(){}

    public static SmptpEmailer getInstance(){
        if(instance == null){
           instance = new SmptpEmailer();
        }
                ...
                "<body>" +
                    "<div class='container'>" +
                        ...
                        "<div class='content'>" +
                            ...
                            "<a href='mailto:" + emailDetails.Email + "' class='button'>Reply to " + emailDetails.Name + "</a>" +
                        "</div>" +
                        "<div class='footer'>" +
